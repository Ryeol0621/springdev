...
<nav class="navbar navbar-inverse">
  <div class="container-fluid">
    ...
    <div class="collapse navbar-collapse" id="myNavbar">
      ...
      <c:if test="${!empty dto}">
	      <ul class="nav navbar-nav navbar-right">
            <li><a href="${contextPath}/memberUpdateForm.do"><span class="glyphicon glyphicon-wrench"></span>회원정보수정</a></li>
            <li><a href="${contextPath}/memberImgForm.do"><span class="glyphicon glyphicon-picture"></span>사진등록</a></li>
